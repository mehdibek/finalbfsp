  ...
  // 
      if (move_uploaded_file($_FILES['fichier']['tmp_name'], $repertoire.$nom_fichier))
      {
       if(isset($_POST['B1'])){
            ...
            $sql = "UPDATE Events SET nom_event=?, img_event=?, date_debut=? , date_fin=? WHERE id_event=?";
            $stmt= $db->prepare($sql);
            $stmt->execute([$name, $image, $date1, $date2, $id]);

            echo '<script language="Javascript"> alert("Événement a été modifier")</script>';
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Modifier un événement 
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <?php 
                ...
                $stmt = $db->query('SELECT * from Events where id_event='.$id_event);
                        ...
                        <form method="post" action="update_event.php" enctype="multipart/form-data">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" class="form-control" id="colFormLabel" placeholder="" name="nom_event" value="<?php echo $row['nom_event'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!--/ input -->
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="fp-default" class="form-control flatpickr-basic" name="date_d" placeholder="Date debut" value="<?php echo $row['date_debut'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!--/ input -->
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="fp-default" class="form-control flatpickr-basic" name="date_f" placeholder="Date fin" value="<?php echo $row['date_fin'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!--/ input -->
