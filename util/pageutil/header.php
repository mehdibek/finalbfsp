    ...
    <!-- BEGIN: Header-->   
        <div class="bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <!--<li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">0</span></a>
                ...
                <?php 
                    ...
                    $stmt = $db->prepare("SELECT c.login, c.role, u.Nom, u.prenom, u.imgprofil from compte c, user u where c.id_user = u.id_user and u.email ='".$email."'"); 
                    $stmt->execute([$email]); 
                    $user = $stmt->fetch();
                ?>
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="user-nav d-sm-flex d-none">
                        	<span class="user-name font-weight-bolder"><?php echo $user[2];?></span>
                        	<span class="user-status"><?php echo $user[1];?></span>
                        </div>
                        <span class="avatar">
                        	<?php if ($user[4] != '') {?>
                        		<img class="round" src="app-assets/images/portrait/small/<?php echo $user[4];?>" alt="avatar" height="40" width="40">
                        		<span class="avatar-status-online"></span>
                        	<?php }else{ ?>
								<img class="round" src="app-assets/images/portrait/small/user_profil.png" alt="avatar" height="40" width="40">
                        		<span class="avatar-status-online"></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="account-settings.php"><i class="mr-50" data-feather="settings"></i> Paramètres</a>
                        <a class="dropdown-item" href="chat.php"><i class="mr-50" data-feather="message-square"></i> Messagerie</a>
