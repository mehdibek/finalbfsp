                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalCenterTitle">
                                                        <img class="round" style="border-radius:7.5rem;border: 1px solid;" src="app-assets/images/company/logo/<?php echo $row['image_ste']?>" style="float: left;"  height="50" width="50" >
                                                        <?php echo $row['nom_ste']; $email = $row['login']; echo $email;?></h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                    ...
                                                    <section class="chat-app-window">
                                                            ...
                                                            <div class="user-chats">
                                                                <div class="chats">
                                                                    <?php $email = $row['login'];
                                                                         ...
                                                                         $sql3 = "SELECT Chatmessage.*, compte.* from Chatmessage, compte where Chatmessage.id_em= compte.id_compte and compte.login ='".$email."' ";
                                                            ...
                                                            <form class="chat-app-form" action="javascript:void(0);" onsubmit="enterChat();">
                                                                <div class="input-group input-group-merge mr-1 form-send-message">
                                                                    <input type="text" class="form-control message" placeholder="" />
